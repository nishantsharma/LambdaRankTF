...
LambdaRank scores are optimal. Hence, slide2vec.
"""
import urllib, json
import collections
import os
...
class Slide2VecRankingModel(object):
    ...
    def fit(self, X, y, rids, qids, max_k=20, epochs=100):
        """
        ...
        self.model.fit(x_to_send, y_to_send, batch_size=num_samples, shuffle=False, epochs=epochs)
